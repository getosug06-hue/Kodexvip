...
-- Для текущей клиентской архитектуры портала используются публичные политики.
-- При необходимости их можно заменить на более строгие policies после переноса
-- админских операций на серверную функцию.
...
-- После выполнения схемы добавьте в Supabase Storage policies для bucket event-results,
-- если проект не использует публичный bucket по умолчанию.
